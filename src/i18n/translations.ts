  ...
  vi: {
    ...
    timeline: {
      ...
      items: [
        ...
        { phase: 'Hạ cánh', date: '27 · 12 · 2026', title: 'Ngày hạ cánh', description: 'Bến đỗ cuối cùng, và cũng là nơi bắt đầu.' },
      ],
    },
    gallery: {
      kicker: 'Album ảnh',
    ...
    meta: {
      ...
      description:
        'Thiệp cưới của Sean Chien và Suri Le — trân trọng kính mời Quý khách cùng chung vui trong ngày trọng đại.',
    },
    ui: {
      music: 'Nhạc nền',
  ...
  en: {
    ...
    timeline: {
      ...
      items: [
        ...
        { phase: 'Landing', date: '27 · 12 · 2026', title: 'Landing day', description: 'Our final stop, and where everything begins.' },
      ],
    },
    gallery: {
      kicker: 'Gallery',
    ...
    meta: {
      ...
      description:
        'Sean Chien and Suri Le request the pleasure of your company as they celebrate their wedding.',
    },
    ui: {
      music: 'Music',
      musicOn: 'Play music',
  ...
  tw: {
    ...
    timeline: {
      ...
      items: [
        ...
        { phase: '降落', date: '2026.12.27', title: '降落之日', description: '最後的停機坪，也是一切的起點。' },
      ],
    },
    gallery: {
      kicker: '相簿',
    ...
    meta: {
      ...
      description:
        'Sean Chien 與 Suri Le 誠摯敬邀您蒞臨婚禮，共同見證幸福時刻。',
    },
    ui: {
      music: '背景音樂',
      musicOn: '播放音樂',
